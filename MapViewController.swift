...
//  A
//
//  Created by MacBook Pro on 1396/6/29 ه‍.ش..
...
class MapViewController: UIViewController ,GMSMapViewDelegate ,  CLLocationManagerDelegate  {
    ...
    override func viewDidLoad() {
        ...
        let camera = GMSCameraPosition.camera(withLatitude: 35.789170, longitude: 51.474872, zoom: 15.0)
...
extension MapViewController: GMSAutocompleteViewControllerDelegate {
    ...
    func viewController(_ viewController: GMSAutocompleteViewController, didAutocompleteWith place: GMSPlace) {
        ...
        if locationSelected == .startLocation {
            ...
            createMarker(titleMarker: "نقطه شروع شما", iconMarker: #imageLiteral(resourceName: "placeholder"), latitude: place.coordinate.latitude, longitude: place.coordinate.longitude)
        } else {
            destinationLocation.text = "\(place.coordinate.latitude), \(place.coordinate.longitude)"
            locationEnd = CLLocation(latitude: place.coordinate.latitude, longitude: place.coordinate.longitude)
            createMarker(titleMarker: " مقصد", iconMarker: #imageLiteral(resourceName: "placeholder"), latitude: place.coordinate.latitude, longitude: place.coordinate.longitude)
        }
